...
<h3 className="my-2 text-lg font-bold text-teal-500 ">Subscribe to Our News Letter</h3>
  ...
  <p className="font-bold text-gray-500 ">We will update you whenever new updates arrive</p>
      ...
      <h3 className='text-lg font-bold text-red-400'>Follow Us to stay in touch</h3>
      <ul className='flex justify-around my-2'>
      <li ><a  href="https://t.me/theprograd_freejobalert_jobs" target="_blank" >
            <svg className=' w-7 h-7 fill-teal-800 hover:fill-slate-900' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Telegram</title><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>
            </a></li>
      <li ><a href="https://www.facebook.com/sayed.anwarulhaq.923" target="_blank" >
            <svg className='w-7 h-7 fill-teal-800 hover:fill-slate-900' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li  ><a href="https://www.instagram.com/theprograd/"  target="_blank">
            ...
            <li ><a href="https://youtube.com/channel/UCFGm2Nfoqs0G29E38B1GZxw" target="_blank" >
            <svg className='w-7 h-7 fill-teal-800 hover:fill-slate-50' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
            </a></li>
      </ul>
  </div>
  </Modal>
