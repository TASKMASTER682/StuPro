        ...
        <>
            <section className="landing " >
                <div className=" big-card p-2 input-box">
                    ...
                    <div className="p-1">
                        ...
                        <Image className="my-1" src='/img/stupro2.png' width={700} height={400}  alt="The ProGrad" placeholder='blur' blurDataURL='/img/blurr-min.jpg' />
            ...
            <section className="section-two my-1">
                ...
                <div className="service-item-1 p-2">
                        ...
                        <div className="p-2">
                        <Image  className="my-1" src='/img/briefcase.png' width={150} height={150} blurDataURL="/img/blurr-min.jpg" alt="The ProGrad" placeholder='blur'  />
                        </div>
                    </div>
                    <div className="service-item p-2">
                    <div className="p-2">
                        <Image className="my-1" src='/img/idea.png' width={150} height={150} blurDataURL="/img/blurr-min.jpg" alt="The ProGrad" placeholder='blur' />
                        </div>
                        <div>
                    ...
                    <div className="service-item-1 p-2">
                        ...
                        <div className="p-2">
                        <Image className="my-1" src='/img/book.png' width={150} height={150}  alt="The ProGrad" placeholder='blur' blurDataURL='/img/blurr-min.jpg' />
                        </div>

                    </div>
                    <div className="service-item p-2">
                    <div className="p-2">
                        <Image className="my-1" src='/img/movie-player.png' width={150} height={150}  alt="The ProGrad" placeholder='blur' blurDataURL='/img/blurr-min.jpg' />
                        </div>              
                         <div>
                    ...
                    <div className="service-item-1 p-2">
                        ...
                        <div className="p-2">
                        <Image className="my-1" src='/img/online-course.png' width={150} height={150}  alt="The ProGrad" placeholder='blur' blurDataURL='/img/blurr-min.jpg' />
                        </div>

                    </div>
                    <div className="service-item p-2">
                    <div className="p-2">
                        <Image  className="my-1" src='/img/test.png' width={150} height={150}  alt="The ProGrad" placeholder='blur' blurDataURL='/img/blurr-min.jpg' />
                        </div>                       
                         <div>
                    ...
                    <div className="service-item-1 p-2">
                        ...
                        <div className="p-2">
                        <Image  className="my-1" src='/img/resume.png' width={150} height={150}  alt="The ProGrad" placeholder='blur' blurDataURL='/img/blurr-min.jpg' />
                        </div>

                    </div>
                    <div className="service-item p-2">
                    <div className="p-2">
                        <Image  className="my-1" src='/img/hired.png' width={150} height={150}  alt="The ProGrad" placeholder='blur' blurDataURL='/img/blurr-min.jpg' />
                        </div>                        <div>
