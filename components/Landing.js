...
const Landing = ({ jobs }) => {
    ...
    return (
       ...
       <ul className='mb-9'>
       <li  className='mb-6 text-4xl text-teal-700 subpixel-antialiased font-extrabold lg:text-8xl'>The ProGrad</li>
       <li className='pl-4 mb-1 text-lg lg:text-xl font-semibold text-gray-600 lg:font-bold'> A Platform Bringing Aspiring Grads And Excelling Professionals Togather.</li>
        <li className='pl-4 mb-1 text-lg lg:text-xl font-semibold text-gray-600 lg:font-bold '> A Community That Has A Perfect Ecosystem For Every Niche Of <span>Education System.</span></li>
        <li className='pl-4 mb-1 text-lg lg:text-xl font-semibold text-gray-600 lg:font-bold '> A Perfect Indian platform to find <span >Govt Jobs ,Private Jobs , Work from home and instatnt Jobs</span></li>
       
       </ul>
       <ul className='flex flex-initial'>
         <li className='p-3 ml-2 font-bold mr-4 bg-gradient-to-r from-green-500 to-teal-400 rounded-sm ring-1 ring-black hover:bg-slate-600 hover:text-slate-100'><Link href="/signup"><a>Signup Here</a></Link></li>
         <li className='p-3 ml-2 font-bold bg-slate-900 rounded-sm ring-1 ring-black hover:bg-slate-600 hover:text-slate-100'><Link   href="/signin"><a className="px-4 py-2 font-bold text-green-300 " >Login</a></Link></li>
       </ul>
